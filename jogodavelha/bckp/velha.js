...
function verificarVitoria() {
    ...
    for (let l = 0; l < jogadas.length; l++) {
        let soma = jogadas[l][0] + jogadas[l][1] + jogadas[l][2];
        if (soma == 3) {
            vencedor = 1;
            jogando = false;
            vit = true;
    ...
    for (let c = 0; c < jogadas.length; c++) {
        let soma = jogadas[0][c] + jogadas[1][c] + jogadas[2][c];
        if (soma == 3) {
            vencedor = 1;
            jogando = false;
            vit = true;
    ...
    //diagonais
    let somaDiagonais = 0;
    somaDiagonais = jogadas[0][0] + jogadas[1][1] + jogadas[2][2];
    if (somaDiagonais == 3) {
        vencedor = 1;
        jogando = false;
        vit = true;
    ...
    somaDiagonais = jogadas[0][2] + jogadas[1][1] + jogadas[2][0];
    if (somaDiagonais == 3) {
        vencedor = 1;
        jogando = false;
        vit = true;
